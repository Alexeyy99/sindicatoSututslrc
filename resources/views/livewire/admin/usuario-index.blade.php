<div wire:init="cargando">
    ...
    <div class="container cont-index">
        <div class="row mb-1">
            ...
            <div class="col-2">
                <a href="{{ route('admin.users.pdf') }}" type="button" class="float-right btn-sm btn btn-dark"><i
                        class="fa fa-save"></i> Generar reporte</a>
            </div>
                            ...
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <a type="button" href="" title="Desactivar al usuario"
                                            class="btn btn-warning btn-sm"><i class="fas fa-user-alt-slash"></i></a>
                                    </th>
                                </tr>
                            @endforeach
                        </tbody>
